...
db.botTransction = require('./bot.transaction.model.js')(
  sequelize,
  Sequelize,
  DataTypes
);
db.userTransaction = require('./user_transaction.model.js')(
  sequelize,
  Sequelize,
  DataTypes
);
db.wallet_transfer = require('./wallet_transfer.model.js')(
  sequelize,
  Sequelize,
  DataTypes
);
db.member = require('./member.model.js')(sequelize, Sequelize, DataTypes);
db.member_record = require('./member_record.model.js')(
  sequelize,
  Sequelize,
  DataTypes
);
db.agent_record = require('./agent_record.model.js')(
  sequelize,
  Sequelize,
  DataTypes
);
db.rolling = require('./rolling.model')(sequelize, Sequelize, DataTypes);
db.rolling_withdraw = require('./rolling_withdraw.model')(
  sequelize,
  Sequelize,
  DataTypes
);
db.mockUserTransaction = require('./mock_user_transaction.model')(
  sequelize,
  Sequelize,
  DataTypes
);
